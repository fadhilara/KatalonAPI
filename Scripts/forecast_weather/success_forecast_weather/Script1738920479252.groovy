...
response = WS.sendRequest(findTestObject('API/forecast weather/forecast_weather', [('url_weather_forecast') : GlobalVariable.url_weather_forecast
...
WS.containsString(response, 'visibility', false)
